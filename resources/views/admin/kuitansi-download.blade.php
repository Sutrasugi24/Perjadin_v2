                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-5 h-6 pt-3"><p class="text-left">Nama/NIP Pegawai yang melaksanakan perjalanan dinas</p></td>
                                <td class="col-6 h-6 p-1">
                                    <p class="text-left mb-0">Sutra Sugi Prabowo</p>
                                    <p class="text-left">NIP.089646771518</p>
                                </td>
                            </tr>
                            <tr class="d-flex">
